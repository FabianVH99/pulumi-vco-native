...
export class ConnectedCloudspace extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectedCloudspace {
        return new ConnectedCloudspace(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vco:cloudspace:ConnectedCloudspace';

    /**
     * Returns true if the given object is an instance of ConnectedCloudspace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ConnectedCloudspace {
    ...
    public readonly connected_cloudspace_id!: pulumi.Output<string>;
    public readonly customerID!: pulumi.Output<string>;
    public /*out*/ readonly local_cloudspace_ip!: pulumi.Output<string>;
    public /*out*/ readonly remote_cloudspace_ip!: pulumi.Output<string>;
