...
export declare class AntiAffinityGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AntiAffinityGroup;
    /**
     * Returns true if the given object is an instance of AntiAffinityGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AntiAffinityGroup;
    ...
    readonly spread: pulumi.Output<number>;
