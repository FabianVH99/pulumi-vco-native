...
export declare class VirtualMachine extends pulumi.CustomResource {
    ...
    readonly cpu_topology: pulumi.Output<outputs.resources.CpuTopology>;
    ...
    readonly disks: pulumi.Output<outputs.resources.VmDisk[]>;
    ...
    readonly network_interfaces: pulumi.Output<outputs.resources.NetworkInterface[]>;
    readonly os_accounts: pulumi.Output<outputs.resources.OsAccount[]>;
