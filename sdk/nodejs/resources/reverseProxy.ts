...
export class ReverseProxy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'vco:resources:ReverseProxy';
    ...
    public readonly back_end!: pulumi.Output<outputs.resources.ReverseProxyBackend>;
    public readonly cloudspace_id!: pulumi.Output<string>;
    public readonly customerID!: pulumi.Output<string>;
    public readonly description!: pulumi.Output<string>;
    public readonly front_end!: pulumi.Output<outputs.resources.ReverseProxyFrontEnd>;
