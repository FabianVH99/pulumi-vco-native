...
{
    [VcoResourceType("vco:ingress:LoadBalancer")]
    public partial class LoadBalancer : global::Pulumi.CustomResource
    {
        ...
        public LoadBalancer(string name, LoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("vco:ingress:LoadBalancer", name, args ?? new LoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancer(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("vco:ingress:LoadBalancer", name, null, MakeResourceOptions(options, id))
        {
        }
