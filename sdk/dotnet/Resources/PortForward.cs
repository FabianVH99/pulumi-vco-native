...
{
    [VcoResourceType("vco:resources:PortForward")]
    public partial class PortForward : global::Pulumi.CustomResource
    {
        ...
        public PortForward(string name, PortForwardArgs args, CustomResourceOptions? options = null)
            : base("vco:resources:PortForward", name, args ?? new PortForwardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PortForward(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("vco:resources:PortForward", name, null, MakeResourceOptions(options, id))
        {
        }
