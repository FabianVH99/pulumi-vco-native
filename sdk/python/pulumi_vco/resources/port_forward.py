...
class PortForwardArgs:
    def __init__(__self__, *,
                 ...
                 nested_cs_id: pulumi.Input[str],
                 protocol: pulumi.Input[str],
                 public_ip: pulumi.Input[str],
                 public_port: pulumi.Input[int],
                 till_public_port: pulumi.Input[int],
    ...
    @property
    @pulumi.getter
    def nested_cs_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "nested_cs_id")

    @nested_cs_id.setter
    def nested_cs_id(self, value: pulumi.Input[str]):
    ...
    @property
    @pulumi.getter
    def till_public_port(self) -> pulumi.Input[int]:
        return pulumi.get(self, "till_public_port")

    @till_public_port.setter
    def till_public_port(self, value: pulumi.Input[int]):
...
class PortForward(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if nested_cs_id is None and not opts.urn:
                raise TypeError("Missing required property 'nested_cs_id'")
            ...
            if till_public_port is None and not opts.urn:
                raise TypeError("Missing required property 'till_public_port'")
