...
func NewReverseProxy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("vco:resources:ReverseProxy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetReverseProxy(ctx *pulumi.Context,
	...
	var resource ReverseProxy
	err := ctx.ReadResource("vco:resources:ReverseProxy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
