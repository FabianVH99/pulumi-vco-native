...
type LoadBalancer struct {
	...
	Tls_termination pulumi.BoolPtrOutput   `pulumi:"tls_termination"`
...
func (o LoadBalancerOutput) Domain() pulumi.StringPtrOutput {
...
func (o LoadBalancerOutput) Ip_address() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LoadBalancer) pulumi.StringPtrOutput { return v.Ip_address }).(pulumi.StringPtrOutput)
}

func (o LoadBalancerOutput) Is_enabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *LoadBalancer) pulumi.BoolPtrOutput { return v.Is_enabled }).(pulumi.BoolPtrOutput)
}
...
func (o LoadBalancerOutput) Port() pulumi.IntOutput {
	return o.ApplyT(func(v *LoadBalancer) pulumi.IntOutput { return v.Port }).(pulumi.IntOutput)
}

func (o LoadBalancerOutput) Serverpool_id() pulumi.StringOutput {
	return o.ApplyT(func(v *LoadBalancer) pulumi.StringOutput { return v.Serverpool_id }).(pulumi.StringOutput)
}

func (o LoadBalancerOutput) Target_port() pulumi.IntOutput {
	return o.ApplyT(func(v *LoadBalancer) pulumi.IntOutput { return v.Target_port }).(pulumi.IntOutput)
}

func (o LoadBalancerOutput) Tls_termination() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *LoadBalancer) pulumi.BoolPtrOutput { return v.Tls_termination }).(pulumi.BoolPtrOutput)
}
