...
type Cloudspace struct {
	...
	Local_domain         pulumi.StringPtrOutput `pulumi:"local_domain"`
...
func (o CloudspaceOutput) Local_domain() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Cloudspace) pulumi.StringPtrOutput { return v.Local_domain }).(pulumi.StringPtrOutput)
}
