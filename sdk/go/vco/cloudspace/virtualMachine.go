...
func (o VirtualMachineOutput) Impact_alert_hook() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VirtualMachine) pulumi.StringPtrOutput { return v.Impact_alert_hook }).(pulumi.StringPtrOutput)
}
