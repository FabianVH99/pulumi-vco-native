...
type VirtualMachineNIC struct {
	...
	External_cloudspace_id pulumi.StringPtrOutput `pulumi:"external_cloudspace_id"`
...
func (o VirtualMachineNICOutput) External_cloudspace_id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VirtualMachineNIC) pulumi.StringPtrOutput { return v.External_cloudspace_id }).(pulumi.StringPtrOutput)
}
